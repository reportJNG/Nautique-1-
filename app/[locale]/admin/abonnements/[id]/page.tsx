...
export default async function AbonnementDetailPage({ params, }: {
    params: {
        locale: string;
        id: string;
    };
        ...
        <Card>
          ...
          <CardContent>
            <div className="flex flex-wrap gap-2">
              {abonnement.statut === "CRE" && (<Button>Mettre ATP</Button>)}
              {abonnement.statut === "ATP" && (<Button>Valider paiement</Button>)}
              {abonnement.statut === "APP" && (<Button>Activer</Button>)}
