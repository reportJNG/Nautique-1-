...
export default async function AdminAbonnementsPage({ params: { locale }, }: {
    params: {
        locale: string;
    };
}) {
        ...
        <CardContent>
          <div className="overflow-x-auto">
            <table className="w-full">
              ...
              <tbody>
                {abonnements.map((abonnement) => (<tr key={abonnement.id} className="border-b hover:bg-gray-50 dark:hover:bg-gray-900">
                    <td className="py-3">
