...
export default async function AdherentDetailPage({ params, }: {
    params: {
        locale: string;
        id: string;
    };
      ...
      <Tabs defaultValue="infos">
            ...
            <CardContent className="pt-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <div className="mt-2">
                    {adherent.actif === 1 ? (<Badge className="bg-green-100 text-green-700">Actif</Badge>) : (<Badge className="bg-gray-100 text-gray-600">Inactif</Badge>)}
                  </div>
                </div>
              </div>
        ...
        <TabsContent value="abonnements" className="mt-4">
          <Card>
            ...
            <CardContent>
              {adherent.abonnements.length === 0 ? (<p className="text-gray-500">Aucun abonnement</p>) : (<div className="space-y-2">
                  {adherent.abonnements.map((abonnement) => (<div key={abonnement.id} className="flex items-center justify-between rounded-lg border p-3">
                      <div>
