...
export default async function AdminAdherentsPage({ params: { locale }, }: {
    params: {
        locale: string;
    };
}) {
        ...
        <CardContent className="pt-6">
          <div className="flex gap-2">
            <div className="relative flex-1">
              ...
              <Input placeholder="Rechercher par nom, email ou n° dossier..." className="pl-10"/>
            </div>
        ...
        <CardContent>
          <div className="overflow-x-auto">
            <table className="w-full">
              ...
              <tbody>
                {adherents.map((adherent) => (<tr key={adherent.id} className="border-b hover:bg-gray-50 dark:hover:bg-gray-900">
