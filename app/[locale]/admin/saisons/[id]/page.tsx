...
export default async function SaisonDetailPage({ params, }: {
    params: {
        locale: string;
        id: string;
    };
      ...
      <Tabs defaultValue="creneaux">
            ...
            <CardContent>
              <div className="overflow-x-auto">
                <table className="w-full">
                  ...
                  <tbody>
                    {saison.creneaux.map((creneau) => (<tr key={creneau.id} className="border-b">
                        <td className="py-3">
        ...
        <TabsContent value="periodes" className="mt-4">
          <Card>
            ...
            <CardContent>
              {saison.periodes.length === 0 ? (<p className="text-gray-500">Aucune période définie</p>) : (<div className="space-y-2">
                  {saison.periodes.map((periode) => (<div key={periode.id} className="rounded-lg border p-3">
                      Du{" "}
