...
type SignupResult = {
    ...
    error: string;
    field?: keyof z.infer<typeof signupSchema> | "general";
...
export async function signupAction(formData: FormData): Promise<SignupResult> {
    try {
        ...
        const { nom, prenom, email, telephone, sexe, dateNaissance, adresse, numeroMatricule, password, } = parsed.data;
        ...
        const organisationCode = numeroMatricule?.trim() ? "SON" : "PAR";
