...
export function AdminGate({ children }: AdminGateProps) {
  const t = useTranslations("auth.staffGate");
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  ...
                  <motion.input
                    ...
                    className={`w-full rounded-xl border bg-background/20 py-2.5 pl-10 pr-10 text-sm text-foreground placeholder:text-muted-foreground outline-none transition-all duration-200 focus:ring-2 disabled:opacity-50 ${
                      error
        ...
        <AnimatePresence>
          {loading && (
            ...
            >
              ...
              <p className="text-xs font-medium text-primary">{t("authenticating")}</p>
            </motion.div>
          )}
        </AnimatePresence>
      </motion.div>
