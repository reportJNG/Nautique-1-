// components/espace/EspaceSidebar.tsx
"use client";
...
export function EspaceSidebar({ adherent }: EspaceSidebarProps) {
  ...
  return (
    <aside className="flex h-screen w-64 flex-col bg-[#0c4a6e] text-white">
      {/* Logo */}
      ...
      <div className="border-t border-white/10 p-4">
        <form action={handleLogout}>
          <Button
            type="submit"
            variant="ghost"
            className="w-full justify-start gap-2 text-cyan-100 hover:bg-white/10 hover:text-white"
          >
