...
export default function DisciplinesSectionClient({ espaces }: Props) {
  ...
  return (
    <section
      id="disciplines"
      className="relative py-32 bg-gradient-to-b from-background via-background to-muted/20"
    >
                    ...
                    <div className="p-8">
                      ...
                      <div className="space-y-3">
                        ...
                        <div className="flex flex-wrap gap-2 max-h-32 overflow-y-auto custom-scrollbar">
                          {espace.disciplines.map((discipline, idx) => (
                            <motion.div
                              key={discipline.id}
                            ...
                            >
                              <Badge
                                variant="secondary"
                                className="px-3 py-1.5 text-sm font-medium cursor-pointer hover:bg-primary hover:text-primary-foreground transition-all duration-300"
                              >
