      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[0, 1, 2].map((idx) => (
              <motion.div
                ...
                className="group relative overflow-hidden rounded-2xl shadow-lg cursor-default"
              >
          ...
          <motion.div
            ...
            onHoverEnd={() => setHoveredIndex(null)}
            className="group relative overflow-hidden rounded-2xl shadow-lg max-w-4xl mx-auto cursor-default"
          >
