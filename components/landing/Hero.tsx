        ...
        >
          <motion.div variants={itemVariants} className="mb-6 flex gap-2">
            <motion.span
              ...
              className="inline-block px-4 py-1.5 rounded-full bg-white/20 backdrop-blur-sm text-white font-semibold text-sm mb-6 border border-white/30"
            >
              Saison 2026 — 2027
            </motion.span>
          </motion.div>
          ...
          <motion.p
            variants={itemVariants}
            className="text-lg md:text-xl text-white/90 max-w-xl mb-10 font-body leading-relaxed drop-shadow-md"
          >
            {t("subtitle")}
          </motion.p>
          ...
          >
            <Link href="/#disciplines">
              <Button
                size="lg"
                className="bg-white text-black hover:bg-white/90 font-semibold text-base px-8 shadow-lg hover:shadow-xl transition-all transform hover:scale-105 cursor-pointer"
              >
                {t("cta")}
            ...
            <Link href="/auth/adherent/login">
              <Button
                size="lg"
                variant="outline"
                className="border-white text-white hover:bg-white/20 font-semibold text-base px-8 backdrop-blur-sm cursor-pointer"
              >
                {navT("loginAdherent")}
              </Button>
            </Link>
