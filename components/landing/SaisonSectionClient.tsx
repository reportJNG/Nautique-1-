...
export default function SaisonSectionClient({ saison, creneauxByDiscipline, locale, }: {
    ...
    if (!saison) {
        ...
        <div className="relative mx-auto max-w-7xl px-4 text-center">
          <motion.div initial={{ scale: 0 }} animate={{ scale: 1 }} transition={{ type: "spring", duration: 0.6 }} className="inline-flex items-center justify-center p-4 bg-gradient-to-br from-cyan-100 to-blue-100 dark:from-cyan-900/40 dark:to-blue-900/40 rounded-2xl mb-6">
  ...
  {activeDay === null && (<motion.div layoutId="activeDayTab" className="absolute inset-0 rounded-2xl bg-gradient-to-r from-cyan-600 to-blue-600" transition={{ type: "spring", bounce: 0.2, duration: 0.6 }}/>)}
    </button>
    ...
    {activeDay === day.value && (<motion.div layoutId="activeDayTab" className="absolute inset-0 rounded-2xl bg-gradient-to-r from-cyan-600 to-blue-600" transition={{ type: "spring", bounce: 0.2, duration: 0.6 }}/>)}
  </button>))}
            </div>
          </div>
        </motion.div>
                  ...
                  <Card className="group h-full overflow-hidden border-0 bg-white/80 dark:bg-gray-900/80 backdrop-blur-sm shadow-lg hover:shadow-2xl transition-all duration-500 hover:-translate-y-2">
                    ...
                    <CardHeader className="relative pb-4 pt-6 px-6 border-b border-border/50">
                      ...
                      <div className="flex items-start justify-between">
                        ...
                        {hasSlots && (<Badge variant="secondary" className="gap-1.5 px-3 py-1.5 bg-gradient-to-r from-cyan-100 to-blue-100 dark:from-cyan-900/50 dark:to-blue-900/50 border-0">
                      ...
                      {hasSlots ? (<div className="space-y-3">
                          {creneaux.slice(0, 5).map((creneau, idx) => (<motion.button key={creneau.id} initial={{ opacity: 0, x: -10 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: idx * 0.05 }} onClick={() => setSelectedTimeSlot(selectedTimeSlot === creneau.id ? null : creneau.id)} className="w-full group/slot relative">
                            ...
                            : "bg-gradient-to-br from-cyan-100 to-blue-100 dark:from-cyan-900/50 dark:to-blue-900/50 text-cyan-600"}`}>
                              ...
                              <AnimatePresence>
                                {selectedTimeSlot === creneau.id && (<motion.div initial={{ opacity: 0, height: 0 }} animate={{ opacity: 1, height: "auto" }} exit={{ opacity: 0, height: 0 }} transition={{ duration: 0.2 }} className="mt-2 ml-12 pl-3 border-l-2 border-cyan-500/30">
