  ...
  return (<section ref={ref} className="py-20">
    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
        {stats.map((stat, idx) => (<div key={idx} className="group relative overflow-hidden rounded-2xl bg-card/80 p-6 text-center backdrop-blur-sm transition-all hover:shadow-xl dark:bg-card/80">
          ...
          <div className="mt-4 text-4xl font-bold text-primary md:text-5xl">
            {isInView && (<CountUp end={stat.value} suffix={stat.suffix} duration={2} separator="," />)}
          </div>
