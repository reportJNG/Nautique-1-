...
export function RecentAbonnementsTable({ abonnements, locale, }: RecentAbonnementsTableProps) {
    ...
    return (<Table>
      ...
      <TableBody>
        {abonnements.map((abonnement) => (<TableRow key={abonnement.id}>
            ...
            <TableCell>
              {formatCurrency(typeof abonnement.montantTtc === "object"
                ? Number(abonnement.montantTtc)
                : abonnement.montantTtc, locale)}
            </TableCell>
